<div class="container my-5" style="max-width: 800px;">
    <div class="card shadow-sm border-0">
        <div class="card-body p-5">
            <h1 class="fw-bold mb-4 text-primary">Tentang Kami</h1>
            
            <p class="lead mb-4">
                <strong>Mandiri Belajar</strong> adalah platform pembelajaran online yang didedikasikan untuk membantu Anda mengembangkan keterampilan baru secara mandiri, fleksibel, dan terstruktur.
            </p>

            <h4 class="fw-bold mt-5 mb-3">Visi Kami</h4>
            <p>Menciptakan akses pendidikan berkualitas yang dapat dijangkau oleh siapa saja, di mana saja, dan kapan saja.</p>

            <h4 class="fw-bold mt-4 mb-3">Misi Kami</h4>
            <ul class="mb-4">
                <li>Menyediakan materi pembelajaran yang relevan dan mudah dipahami.</li>
                <li>Membangun sistem evaluasi yang efektif untuk mengukur kompetensi.</li>
                <li>Mendorong semangat belajar sepanjang hayat (lifelong learning).</li>
            </ul>
